...
const PATIENTS_TABLE = "PatientsDB";
...
const host = "octankserverless-patientdb-instance-1.cmxrjipqkghr.us-east-2.rds.amazonaws.com"
...
module.exports = {
    ...
    createPatient: function (FNAME,LNAME,ADDR,MRN,INS,comp) {
        const dbConn = new Database();
        const insertQuery = "INSERT INTO " + PATIENTS_TABLE + " (FNAME,LNAME,ADDR,MRN,INS,company) VALUES ('" + FNAME + "','" + LNAME + "','" + ADDR + "','" + MRN + "','" + INS + "','" + comp + "');";
        ...
        return dbConn.getDbConfig()
            ...
            .then(dbConn.query.bind(this, insertQuery)).then(results => {
                ...
                return {"PatientSysId": insertId};
            });
    },
    
    getGetPatientbyID: function (id, company) {
        var query = "SELECT * FROM " + PATIENTS_TABLE + " WHERE ID = " + id;
     ...
     listPatients: function (company) {
        var query = "SELECT * FROM " + PATIENTS_TABLE;
